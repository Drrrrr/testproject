...
class CharacteristicsController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Characteristics']))
		{
			...
			if($model->save())
				$this->redirect(array('view','id'=>$model->char_id));
		}
	...
	{
		$dataProvider=new CActiveDataProvider('Characteristics');
	...
	{
		$model=new Characteristics('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Characteristics']))
			$model->attributes=$_GET['Characteristics'];
