...
class Options extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('option_id, question_id, description', 'required'),
			array('option_id, question_id', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('option_id, question_id, description', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'charoptions' => array(self::HAS_MANY, 'Charoptions', 'option_id')
		);
	}
